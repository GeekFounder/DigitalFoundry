  ...
  return (
    <div className="min-h-screen bg-[#0F0F1A]">
      ...
      <section className="bg-gray-100 py-16 sm:py-20 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 text-center px-2">
            Ugly PDFs are silently killing your sponsor deals.
          </h2>
          <p className="text-base sm:text-lg text-gray-600 text-center mb-10 sm:mb-12 max-w-2xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={i} className="bg-white p-5 sm:p-6 rounded-xl border border-gray-200 flex items-start gap-4">
      ...
      <section className="bg-white py-16 sm:py-20 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 max-w-4xl mx-auto">
            {features.map((f, i) => (
              <div key={i} className="bg-gray-50 p-5 sm:p-6 rounded-xl border border-gray-200 flex items-start gap-4 hover:shadow-lg transition-shadow">
                <span className="text-2xl sm:text-3xl flex-shrink-0">{f.icon}</span>
                <div>
                  <h3 className="font-bold text-gray-900 text-base sm:text-lg mb-1">{f.title}</h3>
      ...
      <section className="bg-gray-100 py-12 sm:py-16 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-700 font-medium italic px-4">
          ...
          <div className="max-w-lg mx-auto bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8 md:p-12">
            <div className="text-center mb-8">
              <div className="flex items-center justify-center gap-3 sm:gap-4 mb-2">
                <span className="text-gray-500 line-through text-xl sm:text-2xl">$99</span>
                <span className="text-4xl sm:text-5xl md:text-6xl font-bold text-white">$49</span>
              </div>
              <p className="text-gray-400 text-xs sm:text-sm">Lifetime access · No recurring fees</p>
            </div>
            ...
            <p className="text-gray-500 text-xs sm:text-sm text-center mt-4">Join the waitlist · No payment required now</p>
            {message && (
